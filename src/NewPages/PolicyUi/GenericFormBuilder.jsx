...
// function ExceptionsSection({ parentFormData, setParentFormData }) {
...
//   // Default all form fields to blank
//   const defaults = Object.fromEntries(
//     exceptionFormConfig.screens.ExceptionForm.fields.map(f => [f.name, ""])
//   );
...
//     // if (!formData.name || !formData.application || !formData.protocol) {
//     //   // basic validation
//     //   alert("Please fill name, application and protocol.");
//     //   return;
//     // }
...
//     {exceptionFormConfig.screens.ExceptionForm.fields.map((field) => (
...
//       <td
//         colSpan={
//           exceptionFormConfig.screens.ExceptionForm.fields.length + 1
//         }
...
//       {/* Modal */}
//       {isModalOpen && (
//         <GenericPopupModal isOpen={isModalOpen}
//         onClose={() => setIsModalOpen(false)}
//         >
//           <div className="p-4 space-y-3b">
//             <h2 className="text-lg font-semibold text-gray-100 mb-2">{editMode ? "Edit Exception" : "Add Exception"}</h2>

//             {/* use the simple form renderer you already have */}
//             <GenericFormFields
//               screenConfig={exceptionFormConfig.screens.ExceptionForm}
//               formData={formData}
...
//         // { name: "hobbies", label: "Hobbies", type: "checkbox-group", options: ["Sports", "Music", "Reading", "Gaming"], defaultValue: ["Sports"] },
...
//       customComponent: ({ formData, setFormData }) => (
//         <ExceptionsSection
