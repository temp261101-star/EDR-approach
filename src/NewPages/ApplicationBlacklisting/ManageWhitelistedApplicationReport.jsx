...
function ManageWhitelistedApplicationReport() {

    const navigate = useNavigate();
       const resultData = useSelector((state) => state.app.viewList.resultData) || [];
  ...
  return (
   <div className="p-4">
     ...
     <button
      ...
      {/* Table Section */}
      <Table data={resultData}  showCheckboxes={false} />
    </div> 
  )
}

export default ManageWhitelistedApplicationReport
