...
// Dummy data with hierarchical structure (unchanged)
const dummyData = {
  regions: [
            ...
            <div className="p-2 border-b border-gray-700">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 text-sm bg-gray-700 border border-gray-600 rounded-md text-gray-200 placeholder-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/30"
